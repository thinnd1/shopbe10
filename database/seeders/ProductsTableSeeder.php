...
class ProductsTableSeeder extends Seeder
{
    ...
    {
        $products = [
            ['category_id'=> 1, 'name' => 'apple watch Series 4 (GPS, 40MM)', 'price_unit' => '110.00', 'image' => 'appleWatch_AM.png',
            ...
            ['category_id'=> 1, 'name' => 'Ps4 Pro', 'price_unit' => '300', 'image' => 'Ps4_Pro.jpg',
            ...
            ['category_id'=> 1, 'name' => 'Adidas t-shirt', 'price_unit' => '50.30', 'image' => 't-shirt_Adidas_noir_ce2228.jpg',
             'quantity' => 100,'brand_id'=>3,'product_description'=>'','created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['category_id'=> 1, 'name' => 'nespresso inissia krups coffee machine', 'price_unit' => '79.99', 'image' => 'Nespresso_InissiaKrups_Machine.jpg',
            ...
            ['category_id'=> 1, 'name' => 'Logitech G502 HERO Wired Gaming Mouse','price_unit' => '49.99','image' => 'Logitech_G502_Hero.jpg',
